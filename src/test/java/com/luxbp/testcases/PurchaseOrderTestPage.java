...
public class PurchaseOrderTestPage extends BaseClass {
    ...
    @Test (dataProvider = "logincredentials", groups={"PurchaseOrder"}, description = "Purchase Order Order(s) with only R+Co brand products (only retail $)")
    ...
    @Test (dataProvider = "logincredentials", groups={"PurchaseOrder"}, description = "Purchase Order Order(s) with only R+Co brand products (only NFR points product)")
    ...
    @Test (dataProvider = "logincredentials",groups={"PurchaseOrder"}, description = "Purchase Order(s) with only R+Co brand products (both $ and points product)")
    ...
    @Test (dataProvider = "logincredentials",groups={"PurchaseOrder"}, description = "Purchase Order(s) with only R+Co brand SAME product (both $ and points SAME product)")
    ...
    @Test (dataProvider = "logincredentials",groups={"PurchaseOrder"}, description = "Purchase Order(s) with only R+Co Bleu brand products")
    ...
    @Test (dataProvider = "logincredentials",groups={"PurchaseOrder"}, description = "Purchase Order(s) with only R+Co Bleu brand products (only NFR points product)")
    ...
    @Test (dataProvider = "logincredentials",groups={"PurchaseOrder"}, description = "Purchase Order(s) with only R+Co Bleu brand products (both $ and points product)")
    ...
    @Test (dataProvider = "logincredentials",groups={"PurchaseOrder"}, description = "Purchase Order(s) with only Rbleu brand SAME product (both $ and points SAME product)")
    ...
    @Test (dataProvider = "logincredentials",groups={"PurchaseOrder"}, description = "Purchase Order(s) with only R+Color brand products")
    ...
    @Test (dataProvider = "logincredentials",groups={"PurchaseOrder"}, description = "Purchase Order(s) with only V-76 brand products")
    ...
    @Test (dataProvider = "logincredentials",groups={"PurchaseOrder"}, description = "Purchase Order(s) with only V-76 brand products POINTS")
    ...
    @Test (dataProvider = "logincredentials",groups={"PurchaseOrder"}, description = "Purchase Order(s) with only V-76 brand products BOTH")
    ...
    @Test (dataProvider = "logincredentials",groups={"PurchaseOrder"}, description = "Purchase Order(s) with only V76 brand SAME product (both $ and points SAME product)")
