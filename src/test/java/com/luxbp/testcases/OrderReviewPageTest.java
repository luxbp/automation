...
public class OrderReviewPageTest extends BaseClass {
    ...
    @Test (dataProvider = "logincredentials",description = "Order Review Order(s) with only R+Co brand products (only retail $)", groups={"OrderReview"})
    ...
    @Test (dataProvider = "logincredentials",description = "Order(s) review with only R+Co brand products (only NFR points product)", groups={"OrderReview"})
    ...
    @Test (dataProvider = "logincredentials",description = "Order(s) review with only R+Co brand products (both $ and points product)", groups={"OrderReview"})
    ...
    @Test (dataProvider = "logincredentials",description = "Order(s) review with only R+Co Bleu brand products", groups={"OrderReview"})
    ...
    @Test (dataProvider = "logincredentials",description = "Order(s) review with only R+Co Bleu brand products (only NFR points product)", groups={"OrderReview"})
    ...
    @Test (dataProvider = "logincredentials",description = "Order(s) review with only R+Co Bleu brand products (both $ and points product)", groups={"OrderReview"})
    ...
    @Test (dataProvider = "logincredentials",description = "Order(s) review with only R+Color brand products", groups={"OrderReview"})
    ...
    @Test (dataProvider = "logincredentials",description = "Order(s) review with only V-76 brand products", groups={"OrderReview"})
    ...
    @Test (dataProvider = "logincredentials",description = "Order(s) review with only V-76 brand products POINTS", groups={"OrderReview"})
    ...
    @Test (dataProvider = "logincredentials",description = "Order(s) review with only V-76 brand products BOTH", groups={"OrderReview"})
