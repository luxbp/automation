...
public class PaymentPageTest extends BaseClass {
    ...
    @Test (dataProvider = "logincredentials",description = "Payment Method Order(s) with only R+Co brand products (only retail $)", groups={"PaymentMethod"})
    ...
    @Test (dataProvider = "logincredentials", description = "Payment Method Order(s) with only R+Co brand products (only NFR points product)", groups={"PaymentMethod"})
    ...
    @Test (dataProvider = "logincredentials",description = "Payment Method Order(s) with only R+Co brand products (both $ and points product)", groups={"PaymentMethod"})
    ...
    @Test (dataProvider = "logincredentials", description = "Payment Method Order(s) with only R+Co brand SAME product (both $ and points SAME product)", groups={"PaymentMethod"})
    ...
    @Test (dataProvider = "logincredentials",description = "Payment Method Order(s) with only R+Co Bleu brand products", groups={"PaymentMethod"})
    ...
    @Test (dataProvider = "logincredentials", description = "Payment Method Order(s) with only R+Co Bleu brand products (only NFR points product)", groups={"PaymentMethod"})
    ...
    @Test (dataProvider = "logincredentials",description = "Payment Method Order(s) with only R+Co Bleu brand products (both $ and points product)", groups={"PaymentMethod"})
    ...
    @Test (dataProvider = "logincredentials",description = "Payment Method Order(s) with only Rbleu brand SAME product (both $ and points SAME product)", groups={"PaymentMethod"})
    public void PaymentMethodTestRbleuSameItemBoth(String username,String passsword) throws Throwable {
        ...
        ShippingMethodPageTest shipMethod = new ShippingMethodPageTest();
        shipMethod.ShippingMethodTestRbleuBothSameItem(username, passsword);           //This function will run Shipping method test
    ...
    @Test (dataProvider = "logincredentials", description = "Payment Method Order(s) with only R+Color brand products", groups={"PaymentMethod"})
    ...
    @Test (dataProvider = "logincredentials",description = "Payment Method Order(s) with only V-76 brand products", groups={"PaymentMethod"})
    ...
    @Test (dataProvider = "logincredentials", description = "Payment Method Order(s) with only V-76 brand products POINTS", groups={"PaymentMethod"})
    ...
    @Test (dataProvider = "logincredentials", description = "Payment Method Order(s) with only V-76 brand products BOTH", groups={"PaymentMethod"})
    ...
    @Test (dataProvider = "logincredentials", description = "Payment Method Order(s) with only V76 brand SAME product (both $ and points SAME product)", groups={"PaymentMethod"})
