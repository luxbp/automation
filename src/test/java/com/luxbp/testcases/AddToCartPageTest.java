...
public class AddToCartPageTest extends BaseClass {
    ...
    @Test(priority = 1, dataProvider = "logincredentials", groups={"AddToCart"}, description = "Order(s) with only R+Co brand products (only retail $)")
    ...
    @Test(priority = 2, dataProvider = "logincredentials",groups={"AddToCart"}, description = "Order(s) with only R+Co brand products (only NFR points product)")
    ...
    @Test(priority = 3, dataProvider = "logincredentials", groups={"AddToCart"}, description = "Order(s) with only R+Co brand products BOTH")
    ...
    @Test(priority = 4, dataProvider = "logincredentials",groups={"AddToCart"}, description = "Order(s) with only R+Co brand same product buy from BOTH NFR Point as well as Retail $")
    ...
    @Test(priority = 5, dataProvider = "logincredentials", groups={"AddToCart"}, description = "Order(s) with only R=Bleu brand products")
    ...
    @Test(priority = 6, dataProvider = "logincredentials",groups={"AddToCart"}, description = "Order(s) with only R-Bleu brand products (only NFR points product)")
    ...
    @Test(priority = 7, dataProvider = "logincredentials",groups={"AddToCart"}, description = "Order(s) with only R-Bleu brand products BOTH")
    ...
    @Test(priority = 8, dataProvider = "logincredentials",groups={"AddToCart"}, description = "Order(s) with only R-Bleu brand same product BOTH NFR points and retail $")
    ...
    @Test(priority = 9, dataProvider = "logincredentials",groups={"AddToCart"}, description = "Order(s) with only R+Color brand products")
    ...
    @Test(priority = 10, dataProvider = "logincredentials",groups={"AddToCart"}, description = "Order(s) with only V-76 brand products")
    ...
    @Test(priority = 11, dataProvider = "logincredentials",groups={"AddToCart"}, description = "Order(s) with only V-76 brand products POINTS")
    ...
    @Test(priority = 12, dataProvider = "logincredentials",groups={"AddToCart"}, description = "Order(s) with only V-76 brand products BOTH")
    ...
    @Test(priority = 13, dataProvider = "logincredentials",groups={"AddToCart"}, description = "Order(s) with only V-76 brand products BOTH")
