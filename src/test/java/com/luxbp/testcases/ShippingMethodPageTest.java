...
public class ShippingMethodPageTest extends BaseClass {
    ...
    @Test(dataProvider = "logincredentials",description = "Shipping Method Order(s) with only R+Co brand products (only retail $)", groups={"ShippingMethod"})
    ...
    @Test(dataProvider = "logincredentials",description = "Shipping Method Order(s) with only R+Co brand products (only NFR points product)", groups={"ShippingMethod"})
    ...
    @Test(dataProvider = "logincredentials",description = "Shipping Method Order(s) with only R+Co brand products (both $ and points product)", groups={"ShippingMethod"})
    ...
    @Test(dataProvider = "logincredentials",description = "Shipping Method Order(s) with  R+Co brand SAME product (both $ and points product)", groups={"ShippingMethod"})
    ...
    @Test(dataProvider = "logincredentials",description = "Shipping Method Order(s) with only R-Bleu brand products", groups={"ShippingMethod"})
    ...
    @Test(dataProvider = "logincredentials", description = "Shipping Method Order(s) with only R+Co Bleu brand products (only NFR points product)", groups={"ShippingMethod"})
    ...
    @Test(dataProvider = "logincredentials",description = "Shipping Method Order(s) with only R+Co Bleu brand products (both $ and points product)", groups={"ShippingMethod"})
    ...
    @Test(dataProvider = "logincredentials",description = "Shipping Method Order(s) with  Rbleu brand SAME product (both $ and points product)", groups={"ShippingMethod"})
    ...
    @Test(dataProvider = "logincredentials",description = "Shipping Method Order(s) with only R+Color brand products", groups={"ShippingMethod"})
    ...
    @Test(dataProvider = "logincredentials",description = "Shipping Method Order(s) with only V-76 brand products", groups={"ShippingMethod"})
    ...
    @Test(dataProvider = "logincredentials",description = "Shipping Method Order(s) with only V-76 brand products POINTS", groups={"ShippingMethod"})
    ...
    @Test(dataProvider = "logincredentials",description = "Shipping Method Order(s) with only V-76 brand products BOTH", groups={"ShippingMethod"})
    ...
    @Test(dataProvider = "logincredentials", description = "Shipping Method Order(s) with V76 brand SAME product (both $ and points product)", groups={"ShippingMethod"})
