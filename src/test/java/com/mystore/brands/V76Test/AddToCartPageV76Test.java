...
import com.mystore.pageobjects.AddToCartPage.V76.AddToCartPageV76Dollar;
...
public class AddToCartPageV76Test extends BaseClass {
    ...
    public void addToCartPageV76Dollar() throws Throwable {
        ...
        try {
            ...
            addToCartV76Report.pass("Item added successfully");
